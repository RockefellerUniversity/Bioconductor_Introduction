...
We to convert the entire GRanges to a data.frame using the **as.data.frame()** function.
...
Some particularly useful methods/operators in GenomicRanges allows us to assess the relationship between two sets of GRanges obbjects.
