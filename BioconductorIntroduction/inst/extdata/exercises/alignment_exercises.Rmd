...
In these exercises we will review some of the **QuasR** packages functionality in alignment.
...
4. Create a FASTA file containing sequence for chromosome 12 from Human Hg38 genome build, with contig sequence named "chr12".
...
5. Align the two samples to the chromosome 12 FASTA file using qAlign() function in QuasR in a splice aware mode. Sort and index the resulting alignments
...
fastqFile <- qAlign("SampleTable.txt","chr12.fa",splicedAlignment = TRUE)
sortBam("../Data/heart.bodyMap_29a143839ad.bam","Heart")
sortBam("../Data/liver.bodyMap_29a77529739.bam","Liver")
indexBam("Heart.bam")
indexBam("Liver.bam")
```
