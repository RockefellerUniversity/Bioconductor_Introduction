...
```{r ssslkzzzzfkssjj,eval=F,cache=FALSE,message=FALSE}
hg18TxDb <- makeTxDbFromUCSC(genome="hg18")
hg18TxDb
```

```{r ssslkzzzzfkssjj2, eval=TRUE, echo=F}

saveDb(hg18TxDb, file="data/hg18txdb.RData")
hg18TxDb <- loadDb("data/hg18txdb.RData")
