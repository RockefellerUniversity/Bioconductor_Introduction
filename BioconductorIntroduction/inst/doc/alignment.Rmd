...
![](../../presentations/slides/imgs/IGV_SplicingExample.png)
...
```{r installdesBSded,  echo=toMessage}
...
```{r installssBSded,  echo=toMessage}
...
```{r instalsaslBSded,eval=FALSE,  echo=toMessage}
library(Rsubread)
...
```{r instalssxlBSded,eval=FALSE,  echo=toMessage}
...
```{r instalslBSzzdxed,eval=FALSE,  echo=toMessage}
...
![](../../presentations/slides/imgs/spliceHeartLiver.png)
