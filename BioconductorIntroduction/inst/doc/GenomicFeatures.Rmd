---
title: "Genomic Features in Bioconductor exercises"
...
```{r installBSsz, eval=FALSE,  echo=toMessage}
library(TxDb.Mmusculus.UCSC.mm10.knownGene)
```

2. Count the number of genes and transcripts

```{r installBxxS2,  echo=toMessage}
...
```{r installBS2dcxd3,  echo=toMessage}
...
```{r installBS2ssa3,  echo=toMessage}
...
```{r installBSsccs23,eval=TRUE,  echo=toMessage}
...
```{r installBSsss23,eval=TRUE,  echo=toMessage}
...
```{r installBSsxxs23,eval=TRUE,  echo=toMessage}
...
```{r installBSsxxs2as3,eval=TRUE,  echo=toMessage}
...
```
![](../../presentations/slides/imgs/igvRes.png)
